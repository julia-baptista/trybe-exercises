...
const service = require('./4_service');
...
/**********************************************************************
 ...
 1. mockReturnValue ->  define um valor padrão de retorno.
 2. mockReturnValueOnce -> retorna o valor definido apenas uma vez, e é importante, pois pode ser encadeado para que chamadas sucessivas retornem valores diferentes.
